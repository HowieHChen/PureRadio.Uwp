...
namespace PureRadio.Uwp.Adapters.Interfaces
{
    ...
    {
        /// <summary>
        /// 将来自 Web 的登录结果 <see cref="SignInUserItem"/> 转换为本地账号信息 <see cref="AccountInfo"/> 和本地Token信息 <see cref="TokenInfo"/>.
        /// </summary>
        /// <param name="item">来自 Web 的搜索建议条目.</param>
        (AccountInfo, TokenInfo) ConvertToAccountInfo(SignInUserItem item);
    }
}
